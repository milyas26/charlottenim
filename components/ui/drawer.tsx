  ...
  return (
    <DrawerPortal>
      ...
      <DrawerPrimitive.Content
        ...
        className={cn(
          "fixed inset-x-0 bottom-0 z-50 mt-24 flex max-h-[85vh] flex-col rounded-t-2xl border bg-background",
          className
        )}
        {...props}
      >
...
function DrawerHeader({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn("flex flex-col gap-1.5 px-4 pt-2 pb-4 text-center sm:text-left", className)}
      {...props}
    />
  )
}
