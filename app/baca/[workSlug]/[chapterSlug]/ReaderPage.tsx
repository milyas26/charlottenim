          ...
          <div className="flex items-center justify-between px-3 py-3">
            <div className="flex items-center gap-1 flex-shrink-0">
              {prevChapter ? (
                ...
                <span
                  className="flex items-center gap-1.5 px-3 py-2 rounded-xl text-xs font-semibold opacity-30 flex-shrink-0"
                  style={{
                    color: "var(--muted)",
                    border: "1px solid var(--border)",
                  }}
            ...
            <div className="flex items-center gap-1.5">
              <button
                ...
                style={{
                  backgroundColor: showComments ? "var(--accent)" : "transparent",
                }}
                aria-label="Komentar"
              >
